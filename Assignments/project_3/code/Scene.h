...
public:
	...
	void setPixelSamplingFrequency(int val){
		pixel_sam_freq = val;
		if (pixel_sam_freq < 0){ pixel_sam_freq = 0; }
	}	
	...
	void setLensSamplingFrequency(int val){
		len_sam_freq = val;
		if (len_sam_freq < 0){ len_sam_freq = 0; }
	}
	...
	void setTimeSamplingFrequency(int val){
		time_sam_freq = val;
		if (time_sam_freq < 0){ time_sam_freq = 0; }
	}
	...
	void setPathTracingFrequency(int val){
		path_trace_freq = val;
		if (path_trace_freq <= 0){ path_trace_freq = 1; }
	}
